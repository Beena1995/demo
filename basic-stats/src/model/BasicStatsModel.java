...
public class BasicStatsModel
{
    ...
    /**
     * Does undo operation for a given number.
     *
     * Post-condition: The last added number is removed.
     */
    public void undo() {
        if (this.data.size() == 0) {
            throw new IllegalArgumentException("Can't undo an empty input sequence");
        }
